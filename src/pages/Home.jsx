...
import ProductCard from "../components/UI/product_card/productCard";
        ...
        <Helmet title="Home">
                    ...
                    <Row>
                        <Col lg='6' md='6'>
                            <div  className="hero__content">
                                ...
                                <div className="her0__btn d-flex align-items-center gap-5 mt-4">
                                    <button className="order__btn d-flex align-items-center justify-content-between">
                                        Order Now <i className="ri-arrow-right-s-line"></i>
                                    </button>
                                    <button className="all_food-btn"><Link to='/foods'>See all food</Link></button>
                                </div>
                                <div className="hero__service d-flex align-items-center gap-5 mt-5">
                                    <p className="d-flex align-items-center gap-2">
                                        <span className="shipping__icon">
                                        <i className="ri-roadster-line"></i>
                                        No shipping charge</span></p>

                                    <p className="d-flex align-items-center gap-2">
                                        <span className="shipping__icon">
                                        <i className="ri-shield-check-line"></i>
                                        100% secure checkout</span></p>
                                </div>
                            </div>
                        </Col>
                        <Col lg='6' md='6'>
                ...
                <Container>
                    <Row>
                        <Col lg='12' className="text-center">
                            <h5 className="feature__subtitle">What we server</h5>
                    ...
                    <Row>
                        ...
                        <Col lg='6' md='6'>
                            <div className="why__tasty-treat">
                                <h2 className="tasty__treat-title pt-4">Why <span>Tasty Treat?</span></h2>
            ...
            <section>
                <Container>
                    <Row>
                        <Col lg='6' md='6'>
                            <img src={networkImg} alt="network__img" className="w-100 pb-5"/>
                        </Col>
                        
                        <Col lg='6' md='6'>
                            <div className="testimonial  pt-4">
                                <h5 className="testimonial__subTitle mb-4">Testimonial</h5>
                                <h2 className="testimonial__title">What our <span>customer </span>are saying</h2>
